...
| <a name="input_macie"></a> [macie](#input\_macie) | A collection of Macie settings to apply to the account | <pre>object({<br/>    enable = optional(bool, false)<br/>    # A flag indicating if Macie should be enabled<br/>    frequency = optional(string, "FIFTEEN_MINUTES")<br/>  })</pre> | `null` | no |
