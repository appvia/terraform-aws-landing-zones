...
| <a name="input_landing_zone_tags"></a> [landing\_zone\_tags](#input\_landing\_zone\_tags) | A collection of tags to apply to resources for protection | `map(string)` | <pre>{<br/>  "LandingZone": "true"<br/>}</pre> | no |
